...
-- 补齐安徽省现行区划：安庆市下辖潜山市（340882）。使用幂等写法，兼容已初始化的历史数据库。
INSERT INTO `region_dictionary`
    (`region_code`, `region_name`, `region_level`, `parent_code`, `sort_order`, `is_deleted`)
VALUES ('340882', '潜山市', 3, '340800', 10, 0)
...
-- 旧版初始化数据只包含安徽省和合肥市，补齐安徽其余地级市，保证字典不是“安徽省 -> 合肥市”单一路径。
INSERT INTO `region_dictionary`
    (`region_code`, `region_name`, `region_level`, `parent_code`, `sort_order`, `is_deleted`)
VALUES
    ('340000', '安徽省', 1, NULL, 2, 0),
    ('340100', '合肥市', 2, '340000', 1, 0),
    ('340200', '芜湖市', 2, '340000', 2, 0),
    ('340300', '蚌埠市', 2, '340000', 3, 0),
    ('340400', '淮南市', 2, '340000', 4, 0),
    ('340500', '马鞍山市', 2, '340000', 5, 0),
    ('340600', '淮北市', 2, '340000', 6, 0),
    ('340700', '铜陵市', 2, '340000', 7, 0),
    ('340800', '安庆市', 2, '340000', 8, 0),
    ('341000', '黄山市', 2, '340000', 9, 0),
    ('341100', '滁州市', 2, '340000', 10, 0),
    ('341200', '阜阳市', 2, '340000', 11, 0),
    ('341300', '宿州市', 2, '340000', 12, 0),
    ('341500', '六安市', 2, '340000', 13, 0),
    ('341600', '亳州市', 2, '340000', 14, 0),
    ('341700', '池州市', 2, '340000', 15, 0),
    ('341800', '宣城市', 2, '340000', 16, 0)
ON DUPLICATE KEY UPDATE
    `region_name` = VALUES(`region_name`),
    `region_level` = VALUES(`region_level`),
    `parent_code` = VALUES(`parent_code`),
...
VALUES
    ...
    -- 项目建设地点明确为包河区；安徽省区划字典保留真实区县，不能套用郑州市的“市区”合并规则。
    ('合肥新质产业总部中心项目', '340000', '340100', '340111'),
